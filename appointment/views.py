...
# base viewa for dashboard
def admin_base_view(request):
    return render(request, 'admin/admin_base.html')
def doctor_base_view(request):
    return render(request, 'doctor/doctor_base.html')
def patient_base_view(request):
    return render(request, 'patient/patient_base.html')

# dashboard card
def admin_card_view(request):
    return render(request, 'admin/admin_dashboard_cards.html')
def doctor_card_view(request):
    return render(request, 'doctor/doctor_dashboard_cards.html')
def patient_card_view(request):
    return render(request, 'patient/patient_dashboard_cards.html')
